...
Forked from [https://github.com/projectM-visualizer/projectm](https://github.com/projectM-visualizer/projectm)

Main changes are in src/sdl-test-ui. Lyric Video Studio links dynamically (well, not links, but uses external exe) to that source. Feel free to use this repo if you need, back-link and credits to https://lyricvideo.studio and original project much appreciated
